...
// @@ Pretty good set of tests, but it would be better if
//    each test printed out (or at very least has comments) what
//    the expected output was. Even better would be to test for the
//    expected output in code, and print out success/failure.
int main() {
    const int SIZE = 9;
