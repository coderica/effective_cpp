...
int main() {
    ...
    cout << endl;
	// @@ Bug here. You are returning a list reference (dynamically allocated),
	// but here you are copying it into a local, then never freeing the dynamic allocation.
	// The dynamic allocation was never really necessary in the first place....
